...
const DIALOG_680_WIDTH: PopoverWidthSpec = PopoverWidthSpec::fixed(680.0);
const DIALOG_760_WIDTH: PopoverWidthSpec = PopoverWidthSpec::fixed(760.0);
...
pub(in super::super) fn popover_width_spec(kind: &PopoverKind) -> Option<PopoverWidthSpec> {
    match kind {
        ...
        | PopoverKind::Repo {
            kind: RepoPopoverKind::Subtree(SubtreePopoverKind::RemoveConfirm { .. }),
            ..
        }
        | PopoverKind::ForcePushConfirm { .. }
        | PopoverKind::ForceDeleteBranchConfirm { .. }
        ...
        PopoverKind::Repo {
            kind:
                RepoPopoverKind::Subtree(
                    SubtreePopoverKind::PullPrompt { .. } | SubtreePopoverKind::PushPrompt { .. },
                ),
            ..
        } => Some(DIALOG_640_WIDTH),
        PopoverKind::Repo {
