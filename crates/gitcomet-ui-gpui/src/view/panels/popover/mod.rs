...
pub(in super::super) struct PopoverHost {
    ...
    tag_push_list: Option<gitcomet_core::tag_push::TagPushMode>,
    tag_push_search: Option<Entity<components::TextInput>>,
    _tag_push_search_subscription: Option<gpui::Subscription>,
