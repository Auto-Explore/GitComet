...
fn squash_mode_buttons(
    ...
    div()
        ...
        .gap_2()
        .child(
            components::Button::new("subtree_mode_squash", "Squash")
        ...
        .child(
            components::Button::new("subtree_mode_full", "Full history")
                .style(if squash_enabled {
                    components::ButtonStyle::Outlined
                } else {
                    components::ButtonStyle::Filled
    ...
    div()
        ...
        .child(
            div()
                ...
                .justify_between()
                .child(
                    components::Button::new("subtree_add_cancel", "Cancel")
                ...
                .child(
                    components::Button::new("subtree_add_go", "Add")
                        ...
                        .on_click(theme, cx, move |this, _e, _w, cx| {
                            ...
                            let path_text = this
                                .subtree_path_input
                                .read_with(cx, |i, _| i.text().trim().to_string());
                            if repository.is_empty() || reference.is_empty() || path_text.is_empty()
                            {
                                this.push_toast(
                                    components::ToastKind::Error,
                                    "Subtree repository, reference, and path are required"
                                        .to_string(),
                                    cx,
                                );
                                return;
                            }
                            this.store.dispatch(Msg::AddSubtree {
                                repo_id,
                                repository,
                                reference,
