; Dhall.
;
; Upstream's queries/highlights.scm from https://github.com/jbellerb/tree-sitter-dhall (MIT),
; the revision vendor/tree-sitter-dhall is vendored from. Kept here rather than in
