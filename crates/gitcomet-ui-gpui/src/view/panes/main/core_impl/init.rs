...
impl MainPaneView {
    pub(in crate::view) fn new(
        ...
        let mut pane = Self {
            ...
            markdown_diff_block_scrolls: Default::default(),
            markdown_diff_change_extents: Default::default(),
            markdown_diff_change_extents_key: None,
            markdown_diff_change_extents_requested: None,
